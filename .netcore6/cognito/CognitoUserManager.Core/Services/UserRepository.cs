...
namespace CognitoUserManager.Core.Repositories
{
    public class UserRepository : IUserRepository
    {
        ...
        public UserRepository(IOptions<AppConfig> appConfig, UserContextManager userManager, IHttpContextAccessor httpContextAccessor)
        {
            ...
            _userPool = new CognitoUserPool(_cloudConfig.UserPoolId, _cloudConfig.AppClientId, _provider, _cloudConfig.AppClientSecret);
        ...
        public async Task<UserSignUpResponse> CreateUserAsync(UserSignUpModel model)
        {
            ...
            var signUpRequest = new SignUpRequest
            {
                ...
                SecretHash = CognitoAuthHelper.GetUserPoolSecretHash(model.EmailAddress, _cloudConfig.AppClientId, _cloudConfig.AppClientSecret)
            };
        ...
        public async Task<AuthResponseModel> RefreshTokens(RefreshTokenModel model)
        {
            ...
            authReq.AuthParameters.Add("REFRESH_TOKEN", model.RefreshToken);
            authReq.AuthParameters.Add("SECRET_HASH", CognitoAuthHelper.GetUserPoolSecretHash(model.UserId, _cloudConfig.AppClientId, _cloudConfig.AppClientSecret));

            AdminInitiateAuthResponse authResp = await _provider.AdminInitiateAuthAsync(authReq);
            ...
            var authResponseModel = new AuthResponseModel
            {
                ...
                Tokens = new TokenModel
                {
                    ...
                    RefreshToken = authResp.AuthenticationResult.RefreshToken ?? model.RefreshToken
                },
                IsSuccess = true
            };
        ...
        {
            CognitoUser user = new CognitoUser(emailAddress, _cloudConfig.AppClientId, _userPool, _provider, _cloudConfig.AppClientSecret);
